...
def bk_connection_ok(server, port):
    try:
...
def bh_connection_ok(server, port):
    try:
        return (
            "beehive:20022"
...
def any_ssh_connection_ok(server, port):
    return bh_connection_ok(server, port) or bk_connection_ok(server, port)
